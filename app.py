...
flags.DEFINE_string('train_label', 'polyvore/data/label/train_no_dup.json', 'Training label file')
flags.DEFINE_string('test_label', 'polyvore/data/label/test_no_dup.json', 'Testing label file')
flags.DEFINE_string('valid_label','polyvore/data/label/valid_no_dup.json', 'Validation label file')
flags.DEFINE_string('output_directory', 'polyvore/data/tf_records/', 'Output data directory')
flags.DEFINE_string('image_dir', 'polyvore/data/images/', 'Directory of image patches')
flags.DEFINE_string('word_dict_file', 'polyvore/data/final_word_dict.txt', 'File containing the word dictionary.')
